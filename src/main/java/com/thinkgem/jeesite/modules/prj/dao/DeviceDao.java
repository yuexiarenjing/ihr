...
public class DeviceDao extends BaseDao<Device>  {
	...
	public List<Device> findAllList() {
		return find("from Device where delFlag=:p1 order by id", new Parameter(Device.DEL_FLAG_NORMAL));
	}
	
//	public Device findByLoginName(String loginName){
